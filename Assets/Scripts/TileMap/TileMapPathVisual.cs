...
public class TileMapPathVisual : MonoBehaviour
{
    [System.Serializable]
    ...
    private void Grid_OnGridValueChanged(object sender, Grid<MovementTilemap.TilemapObject>.OnGridValueChangedEvent e)
    {
        updateMesh = true;
    }
